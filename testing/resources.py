...
example_event = Event(
    url='testing/example-event.html',
...
example_event_recurring = Event(
    url='testing/example-event-recurring.html',
...
example_event_recurring_gancio = [
    GancioEvent(
        ...
        place_name='Studio Swing Revolution Trójmiasto',
        place_address='ul. Łąkowa 35/38',
        online_locations=['testing/example-event-recurring.html'],
...
example_event_past = Event(
    url='testing/example-event-past.html',
